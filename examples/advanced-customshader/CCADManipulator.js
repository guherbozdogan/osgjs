(function() {
    ...
    var OSG = window.OSG;
    var osg = OSG.osg;
    var MACROUTILS = OSG.osgUtil;

    var vec3 = osg.vec3;

    var mat4 = osg.mat4;
    var Manipulator = OSG.osgGA.Manipulator;
    ...
    var DelayInterpolator = OSG.osgUtil / DelayInterpolator;

    /**
         *  OrbitManipulator
         *  @class
         */
    var CCADManipulator = function(boundStrategy) {
    ...
    CCADManipulator.AvailableControllerList = [
    ...
    CCADManipulator.ControllerList = [
        'StandardMouseKeyboard',
        'GamePad',
        'Hammer',
        'DeviceOrientation',
    ...
    /** @lends CCADManipulator.prototype */
    MACROUTILS.createPrototypeObject(
        ...
        MACROUTILS.objectInherit(Manipulator.prototype, {
            init: function() {
                ...
                CCADManipulator.ControllerList.forEach(function(value) {
                    if (CCADManipulator[value] !== undefined) {
                        self._controllerList[value] = new CCADManipulator[value](self);
                    }
                });
            },
            setProjectionMatrixAsOrtho: function(left, right, bottom, top, zNear, zFar) {
                ...
                if (this.getCamera() !== undefined) {
                    this.getCamera().setProjectionMatrixAsOrtho(
                        left,
                        right,
                        bottom,
                        top,
            ...
            zoom: (function() {
                ...
                return function(ratio) {
                    ...
                    if (this._top !== 0) {
                        ...
                        this.setProjectionMatrixAsOrtho(
                            this._left,
                            this._right,
                            this._bottom,
                            this._top,
    ...
    CCADManipulator.DeviceOrientation = OrbitManipulatorDeviceOrientationController;
    CCADManipulator.GamePad = OrbitManipulatorGamePadController;
    CCADManipulator.Hammer = OrbitManipulatorHammerController;
    CCADManipulator.WebVR = OrbitManipulatorWebVRController;
    CCADManipulator.StandardMouseKeyboard = OrbitManipulatorStandardMouseKeyboardController;

    window.CCADManipulator = CCADManipulator;
})();
